...
\cite{DBLP:conf/evoW/CalleGGV1919} we explored this approach and found
...
frameworks and therefore a new framework was implemented. The source code is open source and can be found again in GitHub at \url{https://github.com/Laucalle/AngryBirdsLevelGenerator}. % Is this true?
